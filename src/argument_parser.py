...
def add_base_args(parser):  # common arguments for all CLIs
    parser.add_argument('--dataset_name', type=str,
                        ...
                        choices=['Shopping100k', 'DeepFashion', 'DARN','DeepFashion_FineGrained','Shopping100k_subset'],
                        help='Select dataset (Shopping100k or DeepFashion or DARN')
    parser.add_argument('--backbone', type=str,
                        default='alexnet',
                        choices=['alexnet', 'resnet','vit','cca'],
                        help='Select pretrained backbone architecture (alexnet, resnet or vit)')
    ...
    parser.add_argument('--ignore_mis', action='store_true',
                        help='ignore the missing label')
    parser.add_argument('--feat_fusion', action='store_true',
                        help='Enable feature fusion for retrieval')
...
def add_eval_args(parser):
    ...
    parser.add_argument('--fusion_weight', type=float,
                        default=0.7)
    parser.add_argument('--manip_type', type=str,
                        default='aac', choices=['cam', 'aac','block'])

def add_gan_args(parser):
    parser.add_argument('--weight_gan_consist', type=float, default=1.0,
                        help='Weight for gan manipulation consistent loss')
    parser.add_argument('--load_gan',type=str)
    parser.add_argument('--gan_lr',type=float)
    parser.add_argument('--gan_triplet_loss', action='store_true',
                        help='Add triplet loss for fake feature')
    parser.add_argument('--gan_perceptual_loss', action='store_true',
                        help='Add perceptual loss for fake feature')
    parser.add_argument('--gan_triplet_weight', type=float,default=2.0,
                        help='weight for gan triplet loss')
    parser.add_argument('--gan_cls_weight', type=float,default=1.0,
                        help='weight for gan classification loss')
    parser.add_argument('--use_multi_gpu', type=int, default=None)
